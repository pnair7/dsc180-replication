...
filesep = '\\';
mainDir = 'C:\\Users\\Daniel Tong\\Desktop\\school stuff\\DSC\\DSC 180A';
codeDir = 'C:\\Users\\Daniel Tong\\Desktop\\school stuff\\DSC\\DSC 180A';
...
for iInh = inhibitorInds 
    ...
    clear plate*;
    loadFile = [matDir filesep curInhibitor '_nbc.mat'];
    load(loadFile);
    % for each population
    parfor iPop = populationInds
        ...
        %for each activator
        populationData = plateDataNBC(ismember(plateDataNBC(:, [36 38]), [iPop 8],  'rows'), :);
...
% 
fprintf(logFid, '\n=======================================================================================\n');
fprintf(logFid, '                 Finished script_05_store_pvalues_nbc, time elapsed %.3f                     \n', toc(scrTic));
fprintf(logFid, '\n=======================================================================================\n');
fclose(logFid);
