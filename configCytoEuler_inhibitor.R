...
celltypeFile <-
  if(onEuler){
    ...
    "C:/Users/Daniel Tong/Desktop/school stuff/DSC/DSC 180A/BM/_rds/inhibitor-data/cd8+_ inhibitor_BM.rds"
  }
...
removeVars <- c("Time", "EventNum", "DNA-2", "Cell_length", "IgM", "HLA-DR", "DNA-1")
...
saveResultsPath <-
  if(onEuler){
    ...
    "C:/Users/Daniel Tong/Desktop/school stuff/DSC/DSC 180A/BM/_test/"
  }
